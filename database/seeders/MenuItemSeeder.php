            ...
            $menus = [
                ...
                [
                    ...
                    'submenu' => [
                        ...
                        ['name' => 'Customers', 'route' => 'master-data.customer.index', 'permission_name' => 'manage-sales', 'order' => 2],
                    ]
                ],
                ...
                [
                    ...
                    'submenu' => [
                        ...
                        ['name' => 'Suppliers', 'route' => 'master-data.supplier.index', 'permission_name' => 'manage-purchasing', 'order' => 2],
                    ]
                ],
                ...
                [
                    ...
                    'submenu' => [
                        ...
                        ['name' => 'Fixed Assets', 'route' => 'fixed-assets.index', 'permission_name' => 'manage-accounting', 'order' => 4],
                    ]
                ],
                ...
                // == GROUP: PROJECTS ==
                [
                    'group' => 'Projects', 'order' => 50, 'name' => 'Projects', 'route' => 'projectmanagement.projects.index',
                ...
                [
                    ...
                    'submenu' => [
                        ...
                        ['name' => 'Roles & Permissions', 'route' => 'admin.roles.index', 'permission_name' => 'manage-acl', 'order' => 2],
